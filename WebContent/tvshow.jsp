		...
		<div id="carouselExample" class="carousel slide" data-interval="false"
			...
			<div class="carousel-inner" style="margin-left: 25px;">
				<div class="carousel-item active">
					<a class="card cardImg"><img src="/img/sweethome.jpg"
						alt="스위트홈">스위트홈<br>2020</a> <a class="card cardImg"><img
						src="/img/sweethome.jpg" alt="스위트홈">스위트홈<br>2020</a> <a
						class="card cardImg"><img src="/img/sweethome.jpg" alt="스위트홈">스위트홈<br>2020</a>
					<a class="card cardImg"><img src="/img/sweethome.jpg"
						alt="스위트홈">스위트홈<br>2020</a> <a class="card cardImg"><img
						src="/img/sweethome.jpg" alt="스위트홈">스위트홈<br>2020</a>
				</div>
